    ...
    <div class="container background" style="width: 40%">
      <form>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9" style="display: inline-block; text-align: left">
            ...
            <p
              ...
              v-html="passwordCriteria"
            ></p>
            <p v-else id="invalidCritera">&nbsp;</p>
          </div>
        </div>
        <strong><p id="login">Already have an account? Login now!</p> </strong>
        ...
        <button
          ...
          id="registerBtn"
          v-on:click="register()"
          v-if="criteriaArray.every((x) => x == true)"
        >
          REGISTER
        </button>
    ...
    invalidUsername() {
      ...
      if (this.username == "" || !this.username.replace(/\s/g, "").length) {
        ...
        this.usernameCriteria =
          "Invalid Username: Cannot be longer than 15 characters";
        return true;
      } else {
    ...
    invalidPassword() {
      ...
      if (!this.password.match(numbers) && this.password.length < 8) {
        this.passwordCriteria =
          "Invalid Password: At least 8 Characters with a Numeric Number";
        return true;
      ...
      if (x == false && y == false && z == false) {
        try {
          const docRef = await setDoc(doc(db, "Users", email), {
            ...
            phone_num: 0,
            display_pic:
              "https://firebasestorage.googleapis.com/v0/b/safe-travel-1a5dd.appspot.com/o/UsersDP%2FNewAccount%2Fhappyface.jpg?alt=media&token=cb95d3d8-e87c-45a4-a632-9a649405c8bf",
          });
